...
public class NewTaskActivity1 extends AppCompatActivity {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!input.isEmpty()) {
                    ...
                    // 4 verschiedene NewTaskActivities um die fragment_id(1-4) sofort zu übergeben
                    tdb.insertTask(userSingleton.getId(), task); // Füge den Task in die Tabelle ein

                    Toast.makeText(NewTaskActivity1.this, " erfolgreich", Toast.LENGTH_SHORT).show();
                    finish();

                } else {

                    Toast.makeText(NewTaskActivity1.this, "Das Feld darf nicht leer sein", Toast.LENGTH_SHORT).show();
                }
            }
        });
