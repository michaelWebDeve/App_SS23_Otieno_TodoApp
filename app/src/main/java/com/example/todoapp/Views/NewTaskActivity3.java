...
public class NewTaskActivity3 extends AppCompatActivity {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!input.isEmpty()) {
                    ...
                    Toast.makeText(NewTaskActivity3.this, " erfolgreich", Toast.LENGTH_SHORT).show();
                    finish();

                } else {

                    Toast.makeText(NewTaskActivity3.this, "Das Feld darf nicht leer sein",
